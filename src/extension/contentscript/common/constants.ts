/* Keep constants with multiple uses here to avoid duplication and to manage consistency accross messages */

export const DISPLAY_TEXTS = {
    PREFIX_OVERTIME: 'Gleitzeitkonto: ',
    PREFIX_ERROR: 'Fehler: ',
    OVERTIME_LOADING: 'Loading...',
};
